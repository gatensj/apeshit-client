...
exports.sendSignedTransaction = exports.getUnixTs = exports.sendTransactionWithRetry = exports.sendTransaction = exports.sendTransactions = exports.sendTransactionsWithManualRetry = exports.SequenceType = exports.getErrorForTransaction = exports.ENDPOINTS = void 0;
...
exports.getErrorForTransaction = function (connection, txid) { return __awaiter(void 0, void 0, void 0, function () {
    var tx, errors;
...
function sendTransactionsWithManualRetry(connection, wallet, instructions, signers) {
    return __awaiter(this, void 0, void 0, function () {
        var stopPoint, tries, lastInstructionsLength, toRemoveSigners, filteredSigners, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    stopPoint = 0;
                ...
                case 2:
                    ...
                    return [4 /*yield*/, exports.sendTransactionWithRetry(connection, wallet, instructions[0], filteredSigners[0], 'single')];
                case 3:
                    _a.sent();
                    stopPoint = 1;
                    return [3 /*break*/, 6];
                case 4: return [4 /*yield*/, exports.sendTransactions(connection, wallet, instructions, filteredSigners, SequenceType.StopOnFailure, 'single')];
                case 5:
                    stopPoint = _a.sent();
                    _a.label = 6;
...
exports.sendTransactions = function (connection, wallet, instructionSet, signersSet, sequenceType, commitment, successCallback, failCallback, block) {
            ...
            switch (_a.label) {
                ...
                case 2:
                    _loop_1 = function (i) {
                        ...
                        transaction.setSigners.apply(transaction, __spreadArrays([
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    if (!(sequenceType !== SequenceType.Parallel)) return [3 /*break*/, 5];
                                    _a.label = 1;
                                case 1:
                                    _a.trys.push([1, 3, , 4]);
                                ...
                                case 3:
                                    ...
                                    if (breakEarlyObject.breakEarly) {
                                        ...
                                        return [2 /*return*/, { value: breakEarlyObject.i }];
                                    }
                                    return [3 /*break*/, 4];
                ...
                case 8:
                    _a.sent();
                    _a.label = 9;
                case 9: return [2 /*return*/, signedTxns.length];
            }
        });
    });
};
exports.sendTransaction = function (connection, wallet, instructions, signers, awaitConfirmation, commitment, includesFeePayer, block) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 6:
                    ...
                    return [4 /*yield*/, exports.getErrorForTransaction(connection, txid)];
                case 7:
                    errors = _c.sent();
...
exports.sendTransactionWithRetry = function (connection, wallet, instructions, signers, commitment, includesFeePayer, block, beforeSend) {
    if (commitment === void 0) { commitment = 'singleGossip'; }
    if (includesFeePayer === void 0) { includesFeePayer = false; }
    return __awaiter(void 0, void 0, void 0, function () {
